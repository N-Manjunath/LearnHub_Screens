...
const ContactInfoCard = () => {
    ...
    return (
        ...
        <div className="bg-white rounded-xl shadow-2xl p-4 sm:p-5 lg:p-6 h-full w-full">
...
const ContactForm = () => {
    ...
    return (
        // DECREASED HEIGHT: Reduced padding from p-5/sm:p-6/lg:p-8 to p-4/sm:p-5/lg:p-6
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-2xl p-4 sm:p-5 lg:p-6 h-full w-full ">
            <InputField
                label="Your Name"
                name="name"
            ...
            <div className="mt-6">
                <button
                    type="submit"
                    className="w-full flex items-center justify-center space-x-2 px-8 py-3 rounded-xl text-lg font-semibold text-white transition duration-300 hover:opacity-90"
                    style={{ background: `linear-gradient(90deg, ${primaryTeal} 0%, ${primaryBlue} 100%)` }}
                >
                    <Send size={20} />
    ...
    return (
        <>
            ...
            <div className="font-sans bg-gray-50 min-h-screen">
                ...
                <div
                    className="relative inset-0 w-full py-24 sm:py-32 md:py-40 flex items-center justify-center text-center overflow-hidden"
                    style={{
                ...
                <div className="relative -mt-16 md:-mt-24 lg:-mt-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20 pb-16">
