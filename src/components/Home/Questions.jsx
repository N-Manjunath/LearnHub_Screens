                ...
                {faqData.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            <button
                                onClick={() => toggleFAQ(index)}
                                className="flex justify-between items-center w-full py-4 px-6 text-left cursor-pointer transition-colors duration-600"
                                aria-expanded={isOpen}
                            >
                                <span className="text-lg font-semibold">
                                    {item.question}
                                ...
                                <span className={`
                                    ...
                                    rounded-full text-white ml-4 flex-shrink-0
                                    relative
                                    text-2xl font-bold
                                `}>
                                    <span className={`
                                        absolute transition-all duration-600 linear 
                            ...
                            <div
                                className={`
                                    overflow-hidden transition-all duration-600 linear 
                                    ${isOpen ? 'max-h-96' : 'max-h-0'}
                                `}
                            >
                                <p className="w-full md:w-[65%] text-[17px] tracking-[0%] text-[#00000066] font-medium leading-[30px] px-6 pb-8">
                                    {item.answer}
                                </p>
                            </div>
                        </div>
