...
//     return (
//         <section className="bg-white py-8 md:py-16 md:pt-24 px-4 sm:px-6 lg:px-8">
//             <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">

//                 {/* Left Text Block */}
//                 <div className="lg:w-2/5 xl:w-1/3">
//                     <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-6 leading-tight">
//                         Education <span className="text-[#11998d] font-semibold">Beyond Boundaries</span>
//                     </h2>
...
const FeatureCard = ({ title, description, image, content }) => (
    <div className={`relative w-full h-full min-h-[300px] md:min-h-[350px] lg:min-h-[400px] rounded-2xl overflow-hidden shadow-xl transition-transform duration-500 hover:scale-[1.02]`}>
        ...
        <div className="absolute inset-0 p-5 flex flex-col justify-end text-white z-10">
            ...
            {/* Content Text (The main point) */}
            {/* Changed from font-light to font-normal to match Figma */}
    ...
    return (
        <section className="bg-white py-8 md:py-16 md:pt-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
                ...
                <div className="lg:w-2/5 xl:w-1/3">
                    <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-6 leading-tight">
                        Education <span className="text-[#11998d] font-semibold bg-gradient-to-r from-[#0F6EB3] to-[#11998D] bg-clip-text text-transparent">Beyond Boundaries</span>
                    </h2>
                    {/* Updated text size, weight */}
                    <div className="space-y-6 font-normal leading-relaxed text-gray-700 text-lg md:text-xl leading-relaxed">
                        <p>
                            We believe pharmacy education shouldn't be limited by classrooms or rigid schedules.
                        </p>
                        <p>
